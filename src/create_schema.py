...
def generate_bitcoin_schema() -> str:
    """Generate SQL schema for Bitcoin blockchain data."""
    schema = """
-- Blocks table
CREATE TABLE blocks (
...
def main():
    # Generate the schema
    schema = generate_bitcoin_schema()
    
    # Save to file
    output_file = "lastest_block.sql"
    try:
        with open(output_file, 'w') as f:
            f.write(schema)
        print(f"SQL schema has been saved to: {output_file}")
